...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'admin.count', 'car.count', 'fleet_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('car', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('fleet_manager', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'fleet_manager',
          header: 'Fleet Manager',
          accessorKey: 'fleet_manager',
          cell: ({ row: { original: record } }: any) => record?._count?.fleet_manager,
        }
      : null,
