...
import { getFleetManagers, deleteFleetManagerById, createFleetManager } from 'apiSdk/fleet-managers';
      ...
      <Box rounded="md">
        ...
        {isLoading ? (
          ...
          <>
            ...
            <Box borderRadius="10px" border="1px" borderColor={'base.300'} mt={6} p={'18px'}>
              <UserPageTable
                createHandler={createFleetManager}
                deleteHandler={deleteFleetManagerById}
                fetcher={getFleetManagers}
